...
- (IBAction)submitAction:(id)sender {
    ...
    if (!XLCheckPassword(self.validatePasswordTextField.text)) {
    ...
    [UsersModel changePassword:self.oldPasswordTextField.text password:self.passwordTextField.text hanlder:^(id object, NSString *msg) {
        if (object) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LoginContentCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ContenCell" forIndexPath:indexPath];
